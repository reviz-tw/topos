...
export interface TranslationStrings {
  ...
  tabDeliberation: string;
  tabHarmonica: string;
  harmonicaBadge: string;
  harmonicaKicker: string;
  harmonicaDesc: string;
  harmonicaSessionSelector: string;
  harmonicaCreateNew: string;
  harmonicaConnectUrl: string;
  harmonicaConnectPlaceholder: string;
  harmonicaConnectButton: string;
  harmonicaGoalLabel: string;
  harmonicaTurnProgress: (turn: number, max: number) => string;
  harmonicaInterviewerName: string;
  harmonicaThinking: string;
  harmonicaAliasPrompt: string;
  harmonicaAliasPlaceholder: string;
  harmonicaStartButton: string;
  harmonicaDoneTitle: string;
  harmonicaDoneDesc: string;
  harmonicaExportCsv: string;
  harmonicaExportJson: string;
  harmonicaModelNotice: string;
  harmonicaCreateTitle: string;
  harmonicaCreateTopicLabel: string;
  harmonicaCreateGoalLabel: string;
  harmonicaCreateQuestionsLabel: string;
  harmonicaCreateSubmit: string;
  harmonicaCreateCancel: string;
  harmonicaCruxAutoFill: string;
}
...
export const TRANSLATIONS: Record<SupportedLanguage, TranslationStrings> = {
  'zh-TW': {
    ...
    tabDeliberation: '🏛️ 觀點思辨與爭點探索',
    tabHarmonica: '🎙️ 一對一 AI 訪談 (Harmonica)',
    harmonicaBadge: 'HARMONICA · 質性意見訪談',
    harmonicaKicker: '補訪審議裡缺席的聲音',
    harmonicaDesc: '由中立 AI 訪談者為您進行一對一深度訪談，依您所說深入追問、不評價、不說服。訪談紀錄可匯出為 TTTC 格式，與爭點圖譜深度整合。',
    harmonicaSessionSelector: '當前訪談會話',
    harmonicaCreateNew: '➕ 發起新訪談',
    harmonicaConnectUrl: '🔗 連接外部訪談',
    harmonicaConnectPlaceholder: '輸入 Harmonica 連結或 10 碼 Session ID（例如 6o0ryapw2o）',
    harmonicaConnectButton: '載入訪談',
    harmonicaGoalLabel: '這輪訪談想理解什麼：',
    harmonicaTurnProgress: (turn, max) => `第 ${turn} / ${max} 輪回覆`,
    harmonicaInterviewerName: 'AI 訪談者 (Harmonica Facilitator)',
    harmonicaThinking: 'AI 訪談者正在聆聽並思考追問…',
    harmonicaAliasPrompt: '暱稱或代表身分（選填）：',
    harmonicaAliasPlaceholder: '例如：在地居民、通勤族、產業代表…',
    harmonicaStartButton: '開始一對一訪談 →',
    harmonicaDoneTitle: '訪談已圓滿結束，感謝您的寶貴觀點！',
    harmonicaDoneDesc: '您的真實心聲與觀點已被完整記錄，可點擊下方按鈕匯出逐字稿，或交由 Topos 與 Pocket TTTC 整理為核心議題樹。',
    harmonicaExportCsv: '匯出 tttc.csv',
    harmonicaExportJson: '匯出完整 JSON 紀錄',
    harmonicaModelNotice: '由 Google Gemma 4 (@cf/google/gemma-4-26b-a4b-it) 免費推論驅動 · Cloudflare Workers AI',
    harmonicaCreateTitle: '發起新的 Harmonica 一對一訪談',
    harmonicaCreateTopicLabel: '訪談主題名稱',
    harmonicaCreateGoalLabel: '這輪想理解什麼（給參與者與訪談者的導引）',
    harmonicaCreateQuestionsLabel: '起始問題（每行一題，建議 1~3 題）',
    harmonicaCreateSubmit: '建立訪談並開始 →',
    harmonicaCreateCancel: '取消',
    harmonicaCruxAutoFill: '⚡ 從當前議題爭點自動填入建議提綱',
  },
  ...
  en: {
    ...
    tabDeliberation: '🏛️ Cruxes & Deliberation',
    tabHarmonica: '🎙️ 1-on-1 AI Interview (Harmonica)',
    harmonicaBadge: 'HARMONICA · STAKEHOLDER INTERVIEWS',
    harmonicaKicker: 'Listening to Voices Missing from Deliberation',
    harmonicaDesc: 'Engage in a one-on-one deep interview with a neutral AI interviewer that follows up on your points without judgment or persuasion. Transcripts export to TTTC format for issue mapping.',
    harmonicaSessionSelector: 'Active Interview Session',
    harmonicaCreateNew: '➕ Create New Interview',
    harmonicaConnectUrl: '🔗 Connect External Session',
    harmonicaConnectPlaceholder: 'Enter Harmonica URL or 10-char Session ID (e.g. 6o0ryapw2o)',
    harmonicaConnectButton: 'Load Session',
    harmonicaGoalLabel: 'What this round aims to understand:',
    harmonicaTurnProgress: (turn, max) => `Turn ${turn} of ${max}`,
    harmonicaInterviewerName: 'AI Interviewer (Harmonica Facilitator)',
    harmonicaThinking: 'Interviewer is listening and reflecting on follow-up…',
    harmonicaAliasPrompt: 'Alias or Identity (Optional):',
    harmonicaAliasPlaceholder: 'e.g., Local Resident, Commuter, Industry Voice…',
    harmonicaStartButton: 'Start 1-on-1 Interview →',
    harmonicaDoneTitle: 'Interview completed! Thank you for sharing your thoughts.',
    harmonicaDoneDesc: 'Your perspectives have been captured. You can export the transcript or feed it into Topos / Pocket TTTC for issue clustering.',
    harmonicaExportCsv: 'Export tttc.csv',
    harmonicaExportJson: 'Export JSON',
    harmonicaModelNotice: 'Powered by Google Gemma 4 (@cf/google/gemma-4-26b-a4b-it) · Cloudflare Workers AI Free Tier',
    harmonicaCreateTitle: 'Create a New Harmonica AI Interview',
    harmonicaCreateTopicLabel: 'Interview Topic Title',
    harmonicaCreateGoalLabel: 'What do you want to understand? (Guideline for participants & AI)',
    harmonicaCreateQuestionsLabel: 'Starter Questions (One per line, 1-3 recommended)',
    harmonicaCreateSubmit: 'Create & Start Interview →',
    harmonicaCreateCancel: 'Cancel',
    harmonicaCruxAutoFill: '⚡ Auto-populate questions from Topic Cruxes',
  },
  ...
  ja: {
    ...
    tabDeliberation: '🏛️ 観点と思考の審議',
    tabHarmonica: '🎙️ 1対1 AIインタビュー (Harmonica)',
    harmonicaBadge: 'HARMONICA · 質的意見インタビュー',
    harmonicaKicker: '議論に届いていない声を聞く',
    harmonicaDesc: '中立的なAIインタビュアーがあなたと1対1で深く対話します。評価や説得はせず、あなたの発言を丁寧に深掘りします。逐字録はTTTC形式で出力可能です。',
    harmonicaSessionSelector: '現在のインタビューセッション',
    harmonicaCreateNew: '➕ 新しいインタビューを作成',
    harmonicaConnectUrl: '🔗 外部インタビューに接続',
    harmonicaConnectPlaceholder: 'HarmonicaのURLまたは10桁のSession IDを入力（例: 6o0ryapw2o）',
    harmonicaConnectButton: '読み込む',
    harmonicaGoalLabel: 'このインタビューで理解したいこと：',
    harmonicaTurnProgress: (turn, max) => `第 ${turn} / ${max} ターンの回答`,
    harmonicaInterviewerName: 'AIインタビュアー (Harmonica Facilitator)',
    harmonicaThinking: 'AIインタビュアーが傾聴し、次の問いを考えています…',
    harmonicaAliasPrompt: 'ニックネームまたは立場（任意）：',
    harmonicaAliasPlaceholder: '例: 地元住民、通勤者、業界関係者…',
    harmonicaStartButton: '1対1インタビューを開始 →',
    harmonicaDoneTitle: 'インタビューが終了しました。ご意見ありがとうございました！',
    harmonicaDoneDesc: 'あなたの大切なご意見が記録されました。逐字録を出力したり、Topos/Pocket TTTCで論点整理に活用できます。',
    harmonicaExportCsv: 'tttc.csv を出力',
    harmonicaExportJson: 'JSON を出力',
    harmonicaModelNotice: 'Google Gemma 4 (@cf/google/gemma-4-26b-a4b-it) 無料推論エンジン駆動 · Cloudflare Workers AI',
    harmonicaCreateTitle: '新しいHarmonica AIインタビューを作成',
    harmonicaCreateTopicLabel: 'インタビューのテーマ名',
    harmonicaCreateGoalLabel: '何について理解を深めたいか（参加者とAIへの指針）',
    harmonicaCreateQuestionsLabel: '最初の質問（1行に1問、1〜3問推奨）',
    harmonicaCreateSubmit: '作成して開始 →',
    harmonicaCreateCancel: 'キャンセル',
    harmonicaCruxAutoFill: '⚡ 現在の論点から推奨質問を自動入力',
  },
  ...
  ko: {
    ...
    tabDeliberation: '🏛️ 쟁점 탐색 및 심의',
    tabHarmonica: '🎙️ 1:1 AI 인터뷰 (Harmonica)',
    harmonicaBadge: 'HARMONICA · 정성 의견 인터뷰',
    harmonicaKicker: '공청회에서 소외된 목소리를 듣다',
    harmonicaDesc: '중립적인 AI 면접관과 일대일 심층 인터뷰를 진행합니다. 평가나 설득 없이 말씀하신 내용을 깊이 있게 되묻습니다. 녹취록은 TTTC 형식으로 내보낼 수 있습니다.',
    harmonicaSessionSelector: '현재 인터뷰 세션',
    harmonicaCreateNew: '➕ 새 인터뷰 개설',
    harmonicaConnectUrl: '🔗 외부 인터뷰 연결',
    harmonicaConnectPlaceholder: 'Harmonica 링크 또는 10자리 Session ID 입력 (예: 6o0ryapw2o)',
    harmonicaConnectButton: '불러오기',
    harmonicaGoalLabel: '이번 인터뷰에서 파악하고자 하는 목표:',
    harmonicaTurnProgress: (turn, max) => `답변 ${turn} / ${max}번째 턴`,
    harmonicaInterviewerName: 'AI 인터뷰어 (Harmonica Facilitator)',
    harmonicaThinking: 'AI 인터뷰어가 경청하며 추가 질문을 고민 중입니다…',
    harmonicaAliasPrompt: '닉네임 또는 입장 (선택사항):',
    harmonicaAliasPlaceholder: '예: 지역 주민, 출퇴근 직장인, 관련 업계 종사자…',
    harmonicaStartButton: '1:1 인터뷰 시작 →',
    harmonicaDoneTitle: '인터뷰가 완료되었습니다. 귀한 의견 감사드립니다!',
    harmonicaDoneDesc: '남겨주신 진솔한 관점이 기록되었습니다. 녹취록을 내보내거나 Topos 및 Pocket TTTC 의제 분석에 연계할 수 있습니다.',
    harmonicaExportCsv: 'tttc.csv 내보내기',
    harmonicaExportJson: 'JSON 내보내기',
    harmonicaModelNotice: 'Google Gemma 4 (@cf/google/gemma-4-26b-a4b-it) 무료 추론 구동 · Cloudflare Workers AI',
    harmonicaCreateTitle: '새로운 Harmonica AI 인터뷰 개설',
    harmonicaCreateTopicLabel: '인터뷰 주제명',
    harmonicaCreateGoalLabel: '이해하고자 하는 핵심 (참여자와 AI 지침)',
    harmonicaCreateQuestionsLabel: '시작 질문 (줄당 1개, 1~3개 권장)',
    harmonicaCreateSubmit: '개설하고 인터뷰 시작 →',
    harmonicaCreateCancel: '취소',
    harmonicaCruxAutoFill: '⚡ 현재 의제 쟁점에서 권장 질문 자동 입력',
  },
  ...
  fr: {
    ...
    tabDeliberation: '🏛️ Points Clés & Délibération',
    tabHarmonica: '🎙️ Entretien IA Individuel (Harmonica)',
    harmonicaBadge: 'HARMONICA · ENTRETIENS QUALITATIFS',
    harmonicaKicker: 'Écouter les voix absentes de la délibération',
    harmonicaDesc: 'Participez à un entretien individuel approfondi avec un enquêteur IA neutre qui approfondit vos propos sans jugement ni persuasion. Exportez au format TTTC.',
    harmonicaSessionSelector: 'Session d\'entretien active',
    harmonicaCreateNew: '➕ Créer un entretien',
    harmonicaConnectUrl: '🔗 Connecter une session externe',
    harmonicaConnectPlaceholder: 'URL Harmonica ou ID à 10 caractères (ex. 6o0ryapw2o)',
    harmonicaConnectButton: 'Charger',
    harmonicaGoalLabel: 'Objectif de compréhension de ce cycle :',
    harmonicaTurnProgress: (turn, max) => `Tour ${turn} sur ${max}`,
    harmonicaInterviewerName: 'Interviewer IA (Harmonica Facilitator)',
    harmonicaThinking: 'L\'interviewer réfléchit à la question suivante…',
    harmonicaAliasPrompt: 'Pseudonyme ou statut (optionnel) :',
    harmonicaAliasPlaceholder: 'ex. Habitant local, usager des transports, expert…',
    harmonicaStartButton: 'Démarrer l\'entretien →',
    harmonicaDoneTitle: 'Entretien terminé ! Merci pour votre contribution.',
    harmonicaDoneDesc: 'Vos réflexions sont enregistrées. Vous pouvez exporter la transcription pour analyse dans Topos / Pocket TTTC.',
    harmonicaExportCsv: 'Exporter tttc.csv',
    harmonicaExportJson: 'Exporter JSON',
    harmonicaModelNotice: 'Propulsé par Google Gemma 4 (@cf/google/gemma-4-26b-a4b-it) · Cloudflare Workers AI',
    harmonicaCreateTitle: 'Créer un nouvel entretien IA Harmonica',
    harmonicaCreateTopicLabel: 'Thème de l\'entretien',
    harmonicaCreateGoalLabel: 'Ce que l\'organisateur cherche à comprendre',
    harmonicaCreateQuestionsLabel: 'Questions de départ (une par ligne, 1 à 3 recommandées)',
    harmonicaCreateSubmit: 'Créer et lancer →',
    harmonicaCreateCancel: 'Annuler',
    harmonicaCruxAutoFill: '⚡ Pré-remplir à partir des controverses du thème',
  },
  ...
  de: {
    ...
    tabDeliberation: '🏛️ Streitpunkte & Deliberation',
    tabHarmonica: '🎙️ 1-zu-1 KI-Interview (Harmonica)',
    harmonicaBadge: 'HARMONICA · QUALITATIVE INTERVIEWS',
    harmonicaKicker: 'Stimmen Gehör schenken, die bisher fehlen',
    harmonicaDesc: 'Nehmen Sie an einem vertieften Einzelinterview mit einer neutralen KI teil, die gezielt nachhakt – ohne zu werten oder zu überreden. Exportierbar im TTTC-Format.',
    harmonicaSessionSelector: 'Aktive Interviewsitzung',
    harmonicaCreateNew: '➕ Neues Interview erstellen',
    harmonicaConnectUrl: '🔗 Externe Sitzung verbinden',
    harmonicaConnectPlaceholder: 'Harmonica-URL oder 10-stellige Session-ID (z. B. 6o0ryapw2o)',
    harmonicaConnectButton: 'Laden',
    harmonicaGoalLabel: 'Erkenntnisziel dieser Runde:',
    harmonicaTurnProgress: (turn, max) => `Runde ${turn} von ${max}`,
    harmonicaInterviewerName: 'KI-Interviewer (Harmonica Facilitator)',
    harmonicaThinking: 'Der Interviewer hört zu und überlegt die nächste Nachfrage…',
    harmonicaAliasPrompt: 'Pseudonym oder Rolle (optional):',
    harmonicaAliasPlaceholder: 'z. B. Anwohner, Pendler, Fachvertreter…',
    harmonicaStartButton: 'Interview starten →',
    harmonicaDoneTitle: 'Interview abgeschlossen! Vielen Dank für Ihre Gedanken.',
    harmonicaDoneDesc: 'Ihre Perspektiven wurden festgehalten. Sie können das Protokoll exportieren und in Topos / Pocket TTTC analysieren.',
    harmonicaExportCsv: 'tttc.csv exportieren',
    harmonicaExportJson: 'JSON exportieren',
    harmonicaModelNotice: 'Betrieben mit Google Gemma 4 (@cf/google/gemma-4-26b-a4b-it) · Cloudflare Workers AI',
    harmonicaCreateTitle: 'Neues Harmonica KI-Interview anlegen',
    harmonicaCreateTopicLabel: 'Thema des Interviews',
    harmonicaCreateGoalLabel: 'Was soll verstanden werden?',
    harmonicaCreateQuestionsLabel: 'Einstiegsfragen (eine pro Zeile, 1–3 empfohlen)',
    harmonicaCreateSubmit: 'Erstellen und starten →',
    harmonicaCreateCancel: 'Abbrechen',
    harmonicaCruxAutoFill: '⚡ Automatisch aus Streitpunkten generieren',
  },
  ...
  es: {
    ...
    tabDeliberation: '🏛️ Puntos Clave y Deliberación',
    tabHarmonica: '🎙️ Entrevista 1 a 1 con IA (Harmonica)',
    harmonicaBadge: 'HARMONICA · ENTREVISTAS CUALITATIVAS',
    harmonicaKicker: 'Dando voz a quienes no están en la mesa',
    harmonicaDesc: 'Participa en una entrevista individual profunda con un entrevistador de IA neutral que profundiza en tus ideas sin juzgar ni persuadir. Exporta en formato TTTC.',
    harmonicaSessionSelector: 'Sesión de entrevista activa',
    harmonicaCreateNew: '➕ Crear nueva entrevista',
    harmonicaConnectUrl: '🔗 Conectar sesión externa',
    harmonicaConnectPlaceholder: 'URL de Harmonica o ID de 10 caracteres (ej. 6o0ryapw2o)',
    harmonicaConnectButton: 'Cargar sesión',
    harmonicaGoalLabel: 'Qué se busca comprender en esta ronda:',
    harmonicaTurnProgress: (turn, max) => `Turno ${turn} de ${max}`,
    harmonicaInterviewerName: 'Entrevistador IA (Harmonica Facilitator)',
    harmonicaThinking: 'El entrevistador está reflexionando en la siguiente pregunta…',
    harmonicaAliasPrompt: 'Alias o identidad (opcional):',
    harmonicaAliasPlaceholder: 'ej. Vecino local, usuario de transporte, representante…',
    harmonicaStartButton: 'Iniciar entrevista 1 a 1 →',
    harmonicaDoneTitle: '¡Entrevista finalizada! Gracias por compartir tu visión.',
    harmonicaDoneDesc: 'Tus perspectivas han quedado registradas. Puedes exportar la transcripción para analizarla en Topos o Pocket TTTC.',
    harmonicaExportCsv: 'Exportar tttc.csv',
    harmonicaExportJson: 'Exportar JSON',
    harmonicaModelNotice: 'Impulsado por Google Gemma 4 (@cf/google/gemma-4-26b-a4b-it) · Cloudflare Workers AI',
    harmonicaCreateTitle: 'Crear nueva entrevista de IA Harmonica',
    harmonicaCreateTopicLabel: 'Título del tema de entrevista',
    harmonicaCreateGoalLabel: 'Qué se busca entender (guía para participantes e IA)',
    harmonicaCreateQuestionsLabel: 'Preguntas iniciales (una por línea, 1 a 3 recomendadas)',
    harmonicaCreateSubmit: 'Crear e iniciar →',
    harmonicaCreateCancel: 'Cancelar',
    harmonicaCruxAutoFill: '⚡ Completar sugerencias a partir de los puntos clave',
  },
  ...
  it: {
    ...
    tabDeliberation: '🏛️ Punti Cruciali e Deliberazione',
    tabHarmonica: '🎙️ Intervista 1 a 1 con IA (Harmonica)',
    harmonicaBadge: 'HARMONICA · INTERVISTE QUALITATIVE',
    harmonicaKicker: 'Dare voce a chi manca nella deliberazione',
    harmonicaDesc: 'Partecipa a un\'intervista individuale approfondita con un intervistatore IA neutrale che approfondisce i tuoi punti di vista senza giudicare né persuadere. Esportabile in TTTC.',
    harmonicaSessionSelector: 'Sessione di intervista attiva',
    harmonicaCreateNew: '➕ Crea nuova intervista',
    harmonicaConnectUrl: '🔗 Connetti sessione esterna',
    harmonicaConnectPlaceholder: 'URL Harmonica o ID di 10 caratteri (es. 6o0ryapw2o)',
    harmonicaConnectButton: 'Carica sessione',
    harmonicaGoalLabel: 'Cosa si vuole comprendere in questa sessione:',
    harmonicaTurnProgress: (turn, max) => `Turno ${turn} di ${max}`,
    harmonicaInterviewerName: 'Intervistatore IA (Harmonica Facilitator)',
    harmonicaThinking: 'L\'intervistatore sta riflettendo sulla prossima domanda…',
    harmonicaAliasPrompt: 'Pseudonimo o ruolo (facoltativo):',
    harmonicaAliasPlaceholder: 'es. Residente locale, pendolare, esperto…',
    harmonicaStartButton: 'Inizia intervista 1 a 1 →',
    harmonicaDoneTitle: 'Intervista completata! Grazie per il tuo prezioso contributo.',
    harmonicaDoneDesc: 'Le tue considerazioni sono state registrate. Puoi esportare la trascrizione per Topos e Pocket TTTC.',
    harmonicaExportCsv: 'Esporta tttc.csv',
    harmonicaExportJson: 'Esporta JSON',
    harmonicaModelNotice: 'Alimentato da Google Gemma 4 (@cf/google/gemma-4-26b-a4b-it) · Cloudflare Workers AI',
    harmonicaCreateTitle: 'Crea una nuova intervista IA Harmonica',
    harmonicaCreateTopicLabel: 'Titolo del tema di intervista',
    harmonicaCreateGoalLabel: 'Obiettivo di comprensione per partecipanti e IA',
    harmonicaCreateQuestionsLabel: 'Domande iniziali (una per riga, 1-3 consigliate)',
    harmonicaCreateSubmit: 'Crea e inizia →',
    harmonicaCreateCancel: 'Annulla',
    harmonicaCruxAutoFill: '⚡ Compila automaticamente dai punti cruciali del tema',
  },
};
